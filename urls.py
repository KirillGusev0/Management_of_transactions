...
urlpatterns = [
    ...
    path('', user_views.home, name="bitrix_home"),
    path("bitrix/", user_views.home, name="bitrix_home"),
    path("bitrix/start/", user_views.oauth_start, name="bitrix_oauth_start"),
    path("bitrix/callback/", user_views.oauth_callback, name="bitrix_oauth_callback"),
